...
public:
  enum {
    WS = 1, INT = 2, SEMICOLON = 3, COMMA = 4, ADD = 5, SUB = 6, MUL = 7, 
    DIV = 8, LPAREN = 9, RPAREN = 10, LBRACE = 11, RBRACE = 12, EQ = 13, 
    NEQ = 14, LT = 15, LE = 16, GT = 17, GE = 18, ASSIGN = 19, RET = 20, 
    IF = 21, ELSE = 22, WHILE = 23, FOR = 24, ID = 25
  };
